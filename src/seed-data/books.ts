...
export const books: Book[] = [
  ...
  // -----------------------------------------------------------------------
  {
    ...
    coverUrl: "/book_covers/book-fellowship.jpg",
    publishedYear: 1954,
  ...
  },
  {
    ...
    author: "J.R.R. Tolkien",
    coverUrl: "/book_covers/book-two-towers.png",
    publishedYear: 1954,
    genreIds: ["genre-fantasy"],
    seriesId: SERIES_IDS.LOTR,
    seriesOrder: 2,
  ...
  },
  {
    ...
    coverUrl: "/book_covers/book-return-of-the-king.png",
    author: "J.R.R. Tolkien",
    publishedYear: 1955,
    genreIds: ["genre-fantasy"],
    seriesId: SERIES_IDS.LOTR,
  ...
  // -----------------------------------------------------------------------
  {
    ...
    coverUrl: "/book_covers/book-way-of-kings.png",
    publishedYear: 2010,
    genreIds: ["genre-fantasy"],
  ...
  // -----------------------------------------------------------------------
  {
    ...
    author: "Andy Weir",
    coverUrl: "/book_covers/book-project-hail-mary.png",
    publishedYear: 2021,
